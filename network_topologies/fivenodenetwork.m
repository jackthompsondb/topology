...
distance_matrix = dlmread('C:\Users\dbjac\Desktop\MATLAB\research\topology\py\distance_matrix.txt', ',');
...
% % Circular
% coords_c = dlmread('C:\Users\dbjac\Desktop\MATLAB\research\topology\py\node_coordinate_circle.txt', ',');
% x = coords_c(:,1);
% y = coords_c(:,2);

% Spectral
coords_c = dlmread('C:\Users\dbjac\Desktop\MATLAB\research\topology\py\spectral_layout.txt', ',');
x = coords_c(:,1);
y = coords_c(:,2);

%kamada kawai
% coords_k = dlmread('C:\Users\dbjac\Desktop\MATLAB\research\topology\py\node_coordinate_kk.txt', ',');
% x = coords_k(:,1);
% y = coords_k(:,2);
